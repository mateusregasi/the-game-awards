      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(children: [
            ...
            SizedBox(height: 20),
            if (widget.game == null && _categories.isNotEmpty) 
              Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    Game g = Game(id: widget.game?.id, userId: _currentUserId ?? 1, name: _nameController.text, description: _descController.text, releaseDate: _dateController.text.isEmpty ? "2025" : _dateController.text);
